...
(Graphically, this could be represented by a plot showing the probability of voting across different ages, highlighting the increasing trend.)
...
(A table would summarize the coefficient estimates for income levels, and a graph could show the voting probability by income level, emphasizing the gradient of increasing likelihood with higher income.)
